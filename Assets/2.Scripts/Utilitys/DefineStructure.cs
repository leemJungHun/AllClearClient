...
namespace DefineServerUtility
{
    ...
    public struct Send_GivingInfo
    {
        [MarshalAs(UnmanagedType.Bool)] public bool _isMaster;
        [MarshalAs(UnmanagedType.U8)] public long _UUID;
        [MarshalAs(UnmanagedType.U4)] public int _avaraeID;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string _NICK;
    }
    [StructLayout(LayoutKind.Sequential)]
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct Send_PlayerPositionUpdate
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string _sessionID;
    }
    [StructLayout(LayoutKind.Sequential)]
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
    public struct Receive_GivingInfo
    {
        [MarshalAs(UnmanagedType.U8)] public long _UUID;
    }
    [StructLayout(LayoutKind.Sequential)]
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct Receive_PlayerPositionUpdate
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string _sessionID;
    }
    [StructLayout(LayoutKind.Sequential)]
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct Receive_GameStart
    {
        [MarshalAs(UnmanagedType.Bool)] public bool _start;
    }
    [StructLayout(LayoutKind.Sequential)]
